...
const frutas1 = ['banana', 'maçã', 'pera', 'uva']
...
Exemplo: o placeholder _MARCA_ dve ser substituído pela 
...
Nesta bateria de exercícios vimos que marca armazena um array no qual o segundo item é "Sony", um dos gêneros da banda Led Zeppelin 
é Rock e que a propriedade moveLearnMethod do Articuno contém um objeto com uma propriedade name que armazena "machine".

Dica: 

Use interpolações.
*/
const paragrafo = `Nesta bateria de exercícios vimos que marca armazena um array no qual o segundo item é ${marca[1]}, 
um dos gêneros da banda ${banda.nome} é ${banda.generos[3]} e que a propriedade moveLearnMethod do Articuno contém 
